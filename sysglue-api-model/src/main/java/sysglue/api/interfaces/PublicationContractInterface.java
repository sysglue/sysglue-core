...
import sysglue.api.model.PublicationContractRequest;
import sysglue.api.model.PublicationContractResponse;

@Path("/publication-contract")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
public interface PublicationContractInterface {
  ...
  @APIResponses(
    value = {
        @APIResponse(
            ...
            content = @Content(
                schema = @Schema(
                    implementation = PublicationContractResponse.class
                )
            )
        ),
        @APIResponse(
  ...
  @POST
  Response create(PublicationContractRequest input);
  ...
  @Path("/{id}")
  @PUT
  Response updateOrCreate(@PathParam("id") UUID id, PublicationContractRequest input);
