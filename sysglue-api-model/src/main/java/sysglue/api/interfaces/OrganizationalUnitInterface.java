...
public interface OrganizationalUnitInterface {
  ...
  @APIResponses(
    value = {
        @APIResponse(
            ...
            content = @Content(
                schema = @Schema(
                    implementation = OrganizationalUnitResponse.class
                )
            )
        ),
        @APIResponse(
  ...
  @POST
  Response create(OrganizationalUnitRequest input);
  ...
  @Path("/{id}")
  @PUT
  Response updateOrCreate(@PathParam("id") UUID id, OrganizationalUnitRequest input);
